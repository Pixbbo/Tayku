...
https.request('https://api.telegram.org/bot'..TokenBot..'/sendMessage?chat_id='..Tayku..'&text='..URL.escape("⌁︙لقد توقف البوت بسبب انهاير الريدز في السيرفر افتح الترمنال وارسل ↫ ⤈\n`service redis start` ")..'&parse_mode=Markdown')
end
os.exit()
end
end
